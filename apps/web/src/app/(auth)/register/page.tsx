...
export const metadata: Metadata = {
	title: "Register",
	description:
		"Create your Memoria account and start protecting your codebase from breaking changes.",
};
				...
				<div className="grid md:grid-cols-2 gap-12 items-center">
					...
					<div className="hidden md:block space-y-6">
						...
						<p className="text-muted-foreground">
							Stop breaking production. Memoria analyzes your git history to
							reveal hidden file dependencies before your AI makes changes.
						</p>
						...
						<Card>
							...
							<CardContent className="space-y-3">
								...
								<p className="text-center text-xs text-muted-foreground pt-2">
									Memoria requires access to your repositories to analyze code
									changes and provide risk assessments.
								</p>
