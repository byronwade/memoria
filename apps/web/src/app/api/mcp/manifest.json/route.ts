	...
	return NextResponse.json(
		{
			...
			version: "1.0.0",
			description:
				"Memoria MCP Server - The Memory Your AI Lacks. Provides file risk analysis, coupling detection, and git history search.",
			...
			tools: [
				{
					name: "analyze_file",
					description:
						"Analyze file coupling, risk score, and dependencies before making changes",
				},
				{
					name: "ask_history",
					description:
						"Search git history to understand why code was written a certain way",
				},
				{
					name: "login",
			...
			endpoints: [
				{
					...
					description:
						"Local installation - works offline with git-based analysis",
				},
				{
					...
					url: `${baseUrl}/api/mcp`,
					description:
						"Remote server - requires authentication for cloud features",
				},
			],
