					...
					<div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
						<section className="space-y-4">
							...
							<p className="text-muted-foreground leading-relaxed">
								Memoria is designed with privacy as a core principle. We process
								your code diffs in-memory and never store your source code. This
						...
						<section className="space-y-4">
							...
							<ul className="list-disc pl-6 space-y-2 text-muted-foreground">
								...
								<li>
									GitHub username and OAuth tokens (for GitHub App integration)
								</li>
							</ul>
						...
						<section className="space-y-4">
							...
							<ul className="list-disc pl-6 space-y-2 text-muted-foreground">
								<li>
									...
									Diffs are processed in-memory and immediately discarded
								</li>
								<li>
									<strong className="text-foreground">
										Secrets or credentials
									</strong>{" "}
									- We never access or store sensitive data from your
									repositories
								</li>
								<li>
									<strong className="text-foreground">
									...
									- Only metadata needed for analysis
								</li>
							</ul>
						</section>
						...
						<section className="space-y-4">
							...
							<p className="text-muted-foreground leading-relaxed">
								Analysis metadata is retained for the duration of your
								subscription plus 30 days. Account data is retained until you
								delete your account. You can request data export or deletion at
								any time.
							</p>
						</section>
						...
						<section className="space-y-4">
							...
							<ul className="list-disc pl-6 space-y-2 text-muted-foreground">
								<li>
									<strong className="text-foreground">GitHub</strong> - For
									OAuth authentication and repository access
								</li>
								<li>
									<strong className="text-foreground">Stripe</strong> - For
									payment processing (we never see your full card number)
								</li>
								<li>
						...
						<section className="space-y-4">
							...
							<p className="text-muted-foreground leading-relaxed">
								If you prefer complete data isolation, you can run Memoria
								entirely on your own infrastructure using the open-source MCP
								server and CLI. No data is sent to our servers in this
								configuration.
							</p>
						</section>
						...
						<section className="space-y-4">
							...
							<p className="text-muted-foreground leading-relaxed">
								...
								management. We do not use tracking cookies or sell data to
								advertisers.
							</p>
						</section>
						...
						<section className="space-y-4">
							...
							<p className="text-muted-foreground leading-relaxed">
								...
								of material changes by email or through the Service.
							</p>
						</section>
