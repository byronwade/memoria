...
function resolveSize(size: number | string | undefined): number {
	...
	if (typeof size === "string") return Number.parseFloat(size) || 24;
	return 24;
}
...
export function Twitter({ className, size = 24, ...props }: IconProps) {
	...
	return (
		<svg
			...
			{...props}
		>
			<path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.74l7.727-8.835L1.5 2.25h7.08l4.263 5.671 5.401-5.671zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
		</svg>
	);
}
